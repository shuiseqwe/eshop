...
<table width="760" border="0" cellspacing="0" cellpadding="0" align="center">
  <tr> 
    <td width="75%" valign="top" align="left"> 
      ...
      <!--当前记录开始                        ############################################################ -->
        <tr> 
          <td valign="middle" align="left">当前为第 ${pager.firstRow+1} 到第 ${pager.lastRow} 条记录，共${pager.lastRow-firstRow}条商品信息 </td>
        </tr>
        <!--当前记录结束                             ################################################### -->
      </table>
      ...
      <!--产品列表开始                                 ################################################################# -->
        ...
        <tr> 
          ...
          <td width="80%">
          <a href="product.jsp?" class="productName">${product.name}</a>
